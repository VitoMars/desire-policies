  ...
  <div class="main-container">
    <div class="container">
      <div class="responsive-margin">
        ...
        <h1>General Terms</h1>
        <p>
          By accessing and placing an order with Desire, you confirm that you
        ...
        <p>
          Under no circumstances shall Desire team be liable for any direct,
          ...
          inability to use, the materials on this site, even if Desire team or
        ...
        <p>
          Desire will not be responsible for any outcome that may occur during
        ...
        <h1>License</h1>
        <p>
          Desire grants you a revocable, non-exclusive, non-transferable,
          limited license to download, install and use the app strictly in
          accordance with the terms of this Agreement.
        </p>
        <p>
          These Terms & Conditions are a contract between you and Desire
          (referred to in these Terms & Conditions as "Desire", "us", "we" or
          "our"), the provider of the Desire website and the services accessible
          from the Desire website (which are collectively referred to in these
          Terms & Conditions as the "Desire Service").
        </p>
        <p>
          You are agreeing to be bound by these Terms & Conditions. If you do
          not agree to these Terms & Conditions, please do not use the Desire
        ...
        <ul>
          ...
          <li>
            ...
            it refers to Desire, that is responsible for your information under
            this Terms & Conditions.
          </li>
          <li>
            Country: where Desire or the owners/founders of Desire are based, in
            this case is
          </li>
          <li>
            Device: any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit Desire and
            use the services.
          </li>
          <li>
            Service: refers to the service provided by Desire as described in
          ...
          <li>
            You: a person or entity that is registered with Desire to use the
            Services.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            ...
            notice of copyright or trademark) of Desire or its affiliates,
            partners, suppliers or the licensors of the app.
          </li>
        </ul>
        <h1>Return and Refund Policy</h1>
        <p>
          Thanks for shopping at Desire. We appreciate the fact that you like to
        ...
        <p>
          ...
          apply to transactions at Desire. We’ll be as brief as our attorneys
          will allow. The main thing to remember is that by placing an order or
          making a purchase at Desire, you agree to the terms along with
          Desire's Privacy Policy.
        </p>
        <p>
        ...
        <p>
          ...
          (collectively, "Suggestions") provided by you to Desire with respect
          to the app shall remain the sole and exclusive property of Desire.
        </p>
        <p>
          Desire shall be free to use, copy, modify, publish, or redistribute
        ...
        <p>
          ...
          contain links to other websites not operated or controlled by Desire.
        ...
        <h1>Cookies</h1>
        <p>
          Desire uses "Cookies" to identify the areas of our website that you
        ...
        <p>
          You acknowledge and agree that Desire may stop (permanently or
          ...
          do not need to specifically inform Desire when you stop using the
          Service. You acknowledge and agree that if Desire disables access to
        ...
        <p>
          Desire reserves the right to modify, suspend or discontinue,
        ...
        <p>
          Desire may from time to time provide enhancements or improvements to
        ...
        <p>
          ...
          of the app. You agree that Desire has no obligation to (i) provide any
        ...
        <p>
          You acknowledge and agree that Desire shall not be responsible for any
          ...
          or any other aspect thereof. Desire does not assume and shall not have
        ...
        <p>
          Desire may, in its sole discretion, at any time and for any or no
        ...
        <p>
          ...
          Desire, in the event that you fail to comply with any provision of
        ...
        <p>
          Termination of this Agreement will not limit any of Desire's rights or
        ...
        <p>
          You agree to indemnify and hold Desire and its parents, subsidiaries,
        ...
        <p>
          ...
          permitted under applicable law, Desire, on its own behalf and on
          ...
          trade practice. Without limitation to the foregoing, Desire provides
        ...
        <p>
          Without limiting the foregoing, neither Desire nor any Desire's
          ...
          content, or e-mails sent from or on behalf of Desire are free of
        ...
        <p>
          ...
          of Desire and any of its suppliers under any provision of this
        ...
        <p>
          ...
          Desire or its suppliers be liable for any special, incidental,
          ...
          provision of this Agreement), even if Desire or any supplier has been
        ...
        <p>
          ...
          notices published by Desire on the Services, shall constitute the
          entire agreement between you and Desire concerning the Services. If
          ...
          term or any other term, and Desire's failure to assert any right or
          provision under this Agreement shall not constitute a waiver of such
          right or provision. YOU AND Desire AGREE THAT ANY CAUSE OF ACTION
        ...
        <p>
          Desire reserves the right, at its sole discretion, to modify or
        ...
        <p>
          ...
          agree to the new terms, you are no longer authorized to use Desire.
        </p>

        <h1>Entire Agreement</h1>
        <p>
          The Agreement constitutes the entire agreement between you and Desire
          regarding your use of the app and supersedes all prior and
          contemporaneous written or oral agreements between you and Desire.
        </p>
        <p>
          You may be subject to additional terms and conditions that apply when
          you use or purchase other Desire's services, which Desire will provide
        ...
        <p>
          ...
          are owned by Desire, its licensors or other providers of such material
          ...
          prior written permission of Desire, unless and except as is expressly
        ...
        <p>
          ...
          REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Desire's INTELLECTUAL
          PROPERTY RIGHTS. The term “dispute” means any dispute, action, or
          other controversy between you and Desire concerning the Services or
        ...
        <p>
          In the event of a dispute, you or Desire must give the other a Notice
          ...
          is sent. After sixty (60) days, you or Desire may commence
          arbitration.
        </p>

        <h1>Binding Arbitration</h1>
        <p>
          If you and Desire don’t resolve any dispute by informal negotiation,
        ...
        <p>
          ...
          and will become the sole property of Desire without any compensation
          or credit to you whatsoever. Desire and its affiliates shall have no
        ...
        <h1>Promotions</h1>
        <p>
          Desire may, from time to time, include contests, promotions,
        ...
        <p>
          ...
          representative of Desire. Desire will be entitled to injunctive or
          ...
          Desire operates and controls the Desire Service from its offices in .
          ...
          who choose to access the Desire Service from other locations do so on
          ...
          Terms & Conditions (which include and incorporate the Desire Privacy
          Policy) contains the entire understanding, and supersedes all prior
          understandings, between you and Desire concerning its subject matter,
        ...
        <h1>Disclaimer</h1>
        <p>
          Desire is not responsible for any content, code or any other
          imprecision.
        </p>
        <p>Desire does not provide warranties or guarantees.</p>
        <p>
          In no event shall Desire be liable for any special, direct, indirect,
        ...
        <p>
          The Desire Service and its contents are provided "as is" and "as
          available" without any warranty or representations of any kind,
          whether express or implied. Desire is a distributor and not a
          publisher of the content supplied by third parties; as such, Desire
          ...
          accessible via the Desire Service. Without limiting the foregoing,
          Desire specifically disclaims all warranties and representations in
          any content transmitted on or in connection with the Desire Service or
          on sites that may appear as links on the Desire Service, or in the
          products provided as a part of, or otherwise in connection with, the
          Desire Service, including without limitation any warranties of
          merchantability, fitness for a particular purpose or non-infringement
          of third party rights. No oral advice or written information given by
          Desire or any of its affiliates, employees, officers, directors,
          ...
          foregoing, Desire does not warrant that the Desire Service will be
